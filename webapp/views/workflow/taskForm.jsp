...
<body>
		  		...
		  		<form action="/workflow/submitTask" method="POST">
			  		<div align="left" class="STYLE21">
				 		...
				 		<c:if test="${outcomeList!=null&&outcomeList.size()>0}">
				 			...
				 			<input type="submit" name="outcome" value="approval" class="button_ok"/>
				 			<input type="submit" name="outcome" value="disapproval" class="button_ok"/>
				 		</c:if>
			 		</div>
			 	</form>
		  	</td>
	...
	<br>
	<c:choose>
	<c:when test="${outcomeList!=null&&outcomeList.size()>0}">
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			  <tr>
			    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			      <tr>
